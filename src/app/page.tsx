        ...
        <div className="text-center">
          ...
          <div className="mt-2 sm:mt-3 mx-auto max-w-xl relative">
            <div className="relative z-10 flex gap-x-3 p-3">
              ...
              <div>
                <BSolid leftIcon={<svg className="shrink-0 size-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8" /><path d="m21 21-4.3-4.3" /></svg>} />
              </div>
            </div>
          ...
          <div className="mt-2 sm:mt-3">
            <BWhite leftIcon={<svg className="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="14" x="2" y="7" rx="2" ry="2" /><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16" /></svg>} text="Text" />
          </div>
        </div>
      </div>
    </div>
